$(function() {
    ...
    $("input,textarea").jqBootstrapValidation({
        ...
        submitSuccess: function($form, event) {
            ...
            $.ajax({
                url: "http://formspree.io/jeuxjouebelge@gmail.com",
                type: "POST",
                data: {
                    name: name,
                    phone: phone,
                ...
                error: function() {
                    ...
                    $('#success > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
                        .append("</button>");
                    $('#success > .alert-danger').append("<strong>Désolé " + firstName + ", il semble que le serveur mail ne réponde pas. Réessaye plus tard!");
